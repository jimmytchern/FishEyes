...
// Tableau contenant les objets instancier avec la class photographer
const photographerList = new PhotographerList();

// le liens vers les données Json Fisheye
const linkToData = "./data/data.json";

// Chargement du fichier json, promesse inclus ok et une erreur de chargement
...
function displayPhotographers() {
  ...
  // tableau contenant les tags selectionner
  const filters = [];
...
// Affichage du bouton d'accessibilité pour revenir en haut sur l'acceuil :
function displayReturnMain() {
  const returnMain = document.querySelector(".return-main ");
  // Ecouteur d'evenement au scroll, je definis une valeur et je décide d'afficher le bouton d'accessibilité avec une condition
